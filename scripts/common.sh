...
export CODE_ROOT="${CODE_ROOT:-${BUNDLE_ROOT}/code/gemma_gate}"
export GEMMA_DIR="${GEMMA_DIR:-${CODE_ROOT}/gemma}"
...
export BASE_MODEL_ID="${BASE_MODEL_ID:-${BUNDLE_ROOT}/models/Gemma-3-4B-IT}"
export GATE_TEXT_MODEL_ID="${GATE_TEXT_MODEL_ID:-${BUNDLE_ROOT}/models/siglip-so400m-patch14-384}"
export PRETRAIN_CHECKPOINT="${PRETRAIN_CHECKPOINT:-${BUNDLE_ROOT}/checkpoints/gemma3_4b_pretrain_gate_projector_l1_sdpa}"
export PRETRAIN_NOGATE_CHECKPOINT="${PRETRAIN_NOGATE_CHECKPOINT:-${BUNDLE_ROOT}/checkpoints/gemma3_4b_pretrain_projector_sdpa}"
export STAGE2_CHECKPOINT="${STAGE2_CHECKPOINT:-${BUNDLE_ROOT}/checkpoints/gemma3_4b_stage2_gate_l1_mask_sdpa}"
export STAGE2_NOGATE_CHECKPOINT="${STAGE2_NOGATE_CHECKPOINT:-${BUNDLE_ROOT}/checkpoints/gemma3_4b_stage2_nogate_sdpa}"

export IMAGE_DATA_ROOT="${IMAGE_DATA_ROOT:-${BUNDLE_ROOT}/data/playground_data}"
export PRETRAIN_DATA="${PRETRAIN_DATA:-${BUNDLE_ROOT}/data/pretrain_llava_v1_5_mix665k_single_noocr_max200_imageonly_strict_noocr.json}"
export PRETRAIN_IMAGE_FOLDER="${PRETRAIN_IMAGE_FOLDER:-${IMAGE_DATA_ROOT}}"
...
export NAPO_DATA="${NAPO_DATA:-${BUNDLE_ROOT}/data/napo/shortcut_generated_vqa/train.json}"
