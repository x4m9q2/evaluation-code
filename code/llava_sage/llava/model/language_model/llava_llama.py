...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        clip_input_ids:Optional[torch.Tensor] = None,
        clip_attn_mask:Optional[torch.Tensor] = None,
        ...
        patch_mask_coverage: Optional[torch.FloatTensor] = None,
        ...
        if _LLAMA_FORWARD_SUPPORTS_CACHE_POSITION:
    ...
    def generate(
        ...
        **kwargs,
        ...
        clip_input_ids = kwargs.pop("clip_input_ids", None)
        clip_attn_mask = kwargs.pop("clip_attn_mask", None)
        patch_mask_coverage = kwargs.pop("patch_mask_coverage", None)
