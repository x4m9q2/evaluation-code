...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/checkpoints/finetune_stage2_train_raw_mask_suppress_mask25_zero1_p2p}"
...
echo "Launching stage-2 xformers finetune with DeepSpeed ZeRO-1 + P2P:"
