...
DATA_PATH="${BUNDLE_ROOT}/data/stage2/train_raw_mixed_qwenratio_oldbase_sam3_plus_vqa_nonumbermask.json"
IMAGE_FOLDER="${BUNDLE_ROOT}/data/images/coco/train2014"
PATCH_MASK_ANALYSIS_PATH="${BUNDLE_ROOT}/data/stage2/patch_mask_analysis_train_raw_qwenkeep_sam3_nonumbermask_compat.npz"
