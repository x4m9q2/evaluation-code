...
REJUDGED_OUTPUTS_PATH = os.path.join(EVAL_ROOT, "rejudged_outputs")
RL_ANNOTATED_PATH = os.path.join(EVAL_ROOT, "rl-annotated")
OUTPUT_PATH = os.path.join(EVAL_ROOT, "final_outputs")
