...
def main():
    ...
    parser.add_argument("--input-dir", type=str, default=os.path.join(eval_root, "ls-anno"),
                        help="Directory containing rl-annotated files")
    parser.add_argument("--output-dir", type=str, default=os.path.join(eval_root, "rl-annotated"),
