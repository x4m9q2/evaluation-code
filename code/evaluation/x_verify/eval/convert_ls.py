...
def main():
    ...
    parser.add_argument("--input-dir", type=str, default="./xVerify-Achieved/eval/ls-anno", 
                        help="Directory containing rl-annotated files")
    parser.add_argument("--output-dir", type=str, default="./xVerify-Achieved/eval/rl-annotated", 
