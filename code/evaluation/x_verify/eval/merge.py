...
# Hardcoded paths
REJUDGED_OUTPUTS_PATH = "./xVerify-Achieved/eval/rejudged_outputs"
RL_ANNOTATED_PATH = "./xVerify-Achieved/eval/rl-annotated"
OUTPUT_PATH = "./xVerify-Achieved/eval/final_outputs"
